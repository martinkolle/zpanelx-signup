...
try{
	...
	$stmt = $db->prepare("INSERT INTO order (fornavn, efternavn, email) value (:fornavn, :efternavn, :email)");
	...
	$stmt->bindParam(':efternavn',$efternavn);
...
<body>
	...
	<div id="wrap">
		...
		<form action="inde2x.php" method="post">
			...
			<input name="efternavn" type="text" value="Efternavn" />
			<input name="telefon" type="text" value="Telefon" />
			<input name="email" type="text" value="email" />
			<input name="adresse" type="text" value="Adresse" />
			<input name="postnummer" type="text" value="Postnummer" />
			<input name="by" type="text" value="By" />
...
<br />
			<input type="radio" name="type" value="web9" /> Web 9,-<br />
			<input type="radio" name="type" value="web49" /> Web 49,- <br />

<h2>Antal måneder </h2>
			<input type="radio" name="month" value="3" /> 3 måneder<br />
			<input type="radio" name="month" value="6" /> 6 måneder <br />
			<input type="radio" name="month" value="12" /> 12 måneder<br />
